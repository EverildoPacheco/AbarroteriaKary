...
namespace AbarroteriaKary.Data;

public partial class KaryDbContext : DbContext
{
    public KaryDbContext()
    {
    }

    public KaryDbContext(DbContextOptions<KaryDbContext> options)
        : base(options)
    {
    }
    ...
    public virtual DbSet<MATERIAL_ENVASE> MATERIAL_ENVASE { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=(LocalDb)\\MSSQLLocalDB;Database=DBABARROTERIAKARY;Trusted_Connection=True;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<MATERIAL_ENVASE>(entity =>
        {
            entity.HasKey(e => e.MATERIAL_ENVASE_ID).HasName("PK_MATERIAL_ENVASE_ID");
        ...
        modelBuilder.Entity<NOTIFICACION>(entity =>
        {
            ...
            entity.Property(e => e.CREADO_POR).HasDefaultValue("SYSTEM");
            entity.Property(e => e.ESTADO).HasDefaultValue("ACTIVO");
            entity.Property(e => e.FECHA_CREACION).HasDefaultValueSql("(getdate())");
        ...
        modelBuilder.Entity<PEDIDO>(entity =>
        {
            ...
            entity.HasOne(d => d.PROVEEDOR).WithMany(p => p.PEDIDO)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<PRODUCTO>(entity =>
        {
            ...
            entity.HasOne(d => d.MATERIAL_ENVASE).WithMany(p => p.PRODUCTO).HasConstraintName("FK_PRODUCTO_MATERIAL");
